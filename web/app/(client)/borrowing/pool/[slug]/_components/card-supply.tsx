...
export default function CardSupply({
  ...
  const handleSupply = useCallback(() => {
    if (validationState.isValid && onSupply) {
      onSupply(rawAmount);
    }
  }, [validationState.isValid, rawAmount, onSupply]);
                ...
                {balanceLoading ? (
                  ...
                  <>
                    <span className="font-medium">
                      {formatCurrency(balanceValue, 18)}
                    </span>
                    <Button
            ...
            {amount && (
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-xs text-muted-foreground">
                  ...
                  <span>
                    {formatCurrency(balanceValue - rawAmount, 2)} remaining
                  </span>
                </div>
              </div>
            )}
